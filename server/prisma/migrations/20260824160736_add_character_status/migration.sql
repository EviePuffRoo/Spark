...
INSERT INTO "new_Character" ("alignment", "attunedItems", "background", "backstory", "createdAt", "disposition", "equippedItems", "factionId", "hiddenFromParty", "id", "kind", "name", "notes", "race", "settlementId", "statBlock", "tags", "templateId", "templateName", "updatedAt", "userId", "worldId") SELECT "alignment", "attunedItems", "background", "backstory", "createdAt", "disposition", "equippedItems", "factionId", "hiddenFromParty", "id", "kind", "name", "notes", "race", "settlementId", "statBlock", "tags", "templateId", "templateName", "updatedAt", "userId", "worldId" FROM "Character";
