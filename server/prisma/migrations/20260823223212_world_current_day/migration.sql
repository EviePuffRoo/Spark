...
INSERT INTO "new_World" ("createdAt", "description", "id", "joinCodeHash", "name", "nextSessionAt", "updatedAt", "userId") SELECT "createdAt", "description", "id", "joinCodeHash", "name", "nextSessionAt", "updatedAt", "userId" FROM "World";
DROP TABLE "World";
