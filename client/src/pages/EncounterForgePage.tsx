...
export function EncounterForgePage() {
  ...
  async function handleGenerate() {
    ...
    setSaveStatus("idle");
    try {
      const generated = await Promise.all(Array.from({ length: quantity }, () => api.generateEncounterTable(form)));
        ...
        <div className="generator-layout">
          <div className="panel">
            ...
            <button className="btn-primary" onClick={handleGenerate} disabled={loading}>
              {loading ? "Rolling…" : quantity > 1 ? `Generate ${quantity} Tables` : "Generate Table"}
            </button>
