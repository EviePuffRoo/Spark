...
INSERT INTO "new_PlayerCharacter" ("abilityScores", "armorClass", "attunedItems", "className", "createdAt", "equippedItems", "hiddenFromParty", "id", "level", "maxHp", "name", "notes", "playerName", "race", "tags", "updatedAt", "userId", "worldId") SELECT "abilityScores", "armorClass", "attunedItems", "className", "createdAt", "equippedItems", "hiddenFromParty", "id", "level", "maxHp", "name", "notes", "playerName", "race", "tags", "updatedAt", "userId", "worldId" FROM "PlayerCharacter";
