...
import { worldTickRouter } from "./routes/worldTick.js";
import { campaignEventLogRouter } from "./routes/campaignEventLog.js";
import { doomClocksRouter } from "./routes/doomClocks.js";
...
import { sessionHighlightsRouter } from "./routes/sessionHighlights.js";
...
import { shopCommissionsRouter } from "./routes/shopCommissions.js";
...
const generateLimiter = rateLimit({
  ...
  limit: async (req) => {
    ...
    return testAwareLimit(user?.tier === "paid" ? PAID_TIER_GENERATE_LIMIT : FREE_TIER_GENERATE_LIMIT);
  },
  standardHeaders: true,
  legacyHeaders: false,
...
app.use("/api/world-tick", worldTickRouter);
app.use("/api/campaign-event-log", campaignEventLogRouter);
app.use("/api/doom-clocks", doomClocksRouter);
...
app.use("/api/session-highlights", sessionHighlightsRouter);
...
app.use("/api/battle-maps", battleMapsRouter);
app.use("/api/shops", shopsRouter);
app.use("/api/shop-commissions", shopCommissionsRouter);
