...
INSERT INTO "new_PlayerCharacter" ("abilityScores", "armorClass", "attunedItems", "className", "classResources", "conditions", "createdAt", "currentHp", "deathSaves", "equippedItems", "hiddenFromParty", "id", "level", "maxHp", "name", "notes", "playerName", "preparedSpells", "race", "spellSlots", "tags", "updatedAt", "userId", "worldId") SELECT "abilityScores", "armorClass", "attunedItems", "className", "classResources", "conditions", "createdAt", "currentHp", "deathSaves", "equippedItems", "hiddenFromParty", "id", "level", "maxHp", "name", "notes", "playerName", "preparedSpells", "race", "spellSlots", "tags", "updatedAt", "userId", "worldId" FROM "PlayerCharacter";
