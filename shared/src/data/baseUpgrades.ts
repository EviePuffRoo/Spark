...
//
// Effects ship in slices: Defenses and Trade carry real, coded effects
// (a defenseRating stat, an actually-generated Shop) as of this pass.
// Influence and Comfort are still flavor-only, pending their own effect
// kinds (automated faction reputation deltas, a real rest bonus) — not
// left that way permanently, just not built yet.
