...
CREATE TABLE "new_Encounter" (
    ...
    "openDoorCells" TEXT NOT NULL DEFAULT '[]',
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Encounter_worldId_fkey" FOREIGN KEY ("worldId") REFERENCES "World" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Encounter" ("activeBattleMapId", "activeDungeonId", "activeDungeonRoomId", "combatants", "exploredCells", "id", "round", "turnIndex", "updatedAt", "worldId", "zoneEffects", "zones") SELECT "activeBattleMapId", "activeDungeonId", "activeDungeonRoomId", "combatants", "exploredCells", "id", "round", "turnIndex", "updatedAt", "worldId", "zoneEffects", "zones" FROM "Encounter";
